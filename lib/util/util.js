...
module.exports = {
	...
	writeCsv: function(_fileName, _str) {
		fs.writeFile(_fileName, _str, function(err) {

			if(err) {
					return console.error(err);
			}

			if(module.exports.logLevel > 0) {
				console.log('CSV file saved successfuly: ' + _fileName);
			}
	});
	},
	...
	time: function() {
		...
		return module.exports.l2(d.getHours()) + ':' + module.exports.l2(d.getMinutes()) + ':' + module.exports.l2(mili < 100 ? mili + '0' : mili);
	},
	timeStamp: function() {
		var d = (new Date());
	...
	filenamify: function(string, options) {
		return filenamify(module.exports.remapInternationalCharToAscii(string), options);
	},
	remapInternationalCharToAscii: function (str) {
